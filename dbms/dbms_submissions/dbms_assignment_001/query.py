Q1="CREATE TABLE User(user_id INT PRIMARY KEY NOT NULL,first_name VARCHAR(200) NOT NULL,last_name VARCHAR(300) NOT NULL,address VARCHAR(300) NOT NULL,phone_number INT NOT NULL);"
